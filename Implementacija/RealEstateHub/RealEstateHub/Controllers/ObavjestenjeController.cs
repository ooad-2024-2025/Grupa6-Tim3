...
namespace RealEstateHub.Controllers
{
    public class ObavjestenjeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("obavjestenjeId,korisnikId,datumObavjestenja,poruka")] Obavjestenje obavjestenje)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("obavjestenjeId,korisnikId,datumObavjestenja,poruka")] Obavjestenje obavjestenje)
        {
        ...
        {
            return _context.Obavjestenje.Any(e => e.obavjestenjeId == id);
        }
    }
}
