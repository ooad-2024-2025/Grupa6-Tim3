...
namespace RealEstateHub.Controllers
{
    public class LokacijaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("lokacijaId,nekretninaId,grad,adresa,latituda,longituda")] Lokacija lokacija)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("lokacijaId,nekretninaId,grad,adresa,latituda,longituda")] Lokacija lokacija)
        {
